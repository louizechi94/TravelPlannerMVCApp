        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduledEvents_Itineraries_ItineraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_Itineraries_ItineraryId",
                        column: x => x.ItineraryId,
                        principalTable: "Itineraries",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DestinationTrip_Destinations_DestinationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledEvents_ItineraryId",
                table: "ScheduledEvents",
                column: "ItineraryId");

            migrationBuilder.CreateIndex(
                name: "IX_Trips_ItineraryId",
                table: "Trips",
                column: "ItineraryId");
